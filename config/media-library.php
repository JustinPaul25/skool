...
return [
    ...
    /*
     * When true, media URLs point at this Laravel app (see routes/web.php) so uploads load in
     * Filament/FilePond without cross-origin fetch/CORS against Spaces/S3. Set false and configure
     * bucket CORS if you prefer direct CDN URLs.
     */
    'use_same_origin_urls' => filter_var(env('MEDIA_SAME_ORIGIN_URLS', true), FILTER_VALIDATE_BOOLEAN),
     ...
     */
    'url_generator' => App\Media\Support\SameOriginUrlGenerator::class,
